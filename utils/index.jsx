...
import {
  getWebLocaleCountryIsoUpper,
  getWebPhoneCountryIsoUpper,
} from "@/constants/webCountryScope";
...
export const formatPriceAbbreviated = (price) => {
  ...
  const countryCode = getWebLocaleCountryIsoUpper();
...
export const getDefaultCountryCode = (
  defaultCountry = getWebPhoneCountryIsoUpper()
) => {
  try {
    if (defaultCountry) {
  ...
  try {
    return getCountryCallingCode(getWebPhoneCountryIsoUpper());
  } catch {
    return "43";
  }
};
