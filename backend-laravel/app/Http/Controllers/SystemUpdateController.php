    ...
    public function update(Request $request) {
        ...
        try {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL            => 'https://validator.wrteam.in/kaufmarkt_validator?purchase_code=' . $request->input('purchase_code') . '&domain_url=' . $app_url,
...
//                sprintf('Directory "%s" was not created', $concurrentDirectory)
    ...
    public function resetPurchaseCode(Request $request)
    {
        ...
        try {
            ...
            $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL            => 'https://validator.wrteam.in/kaufmarkt_reset_purchase_code?purchase_code=' . $purchase_code . '&domain=' . $domain,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_MAXREDIRS      => 10,
                CURLOPT_FOLLOWLOCATION => true,
                CURLOPT_HTTP_VERSION   => CURL_HTTP_VERSION_1_1,
